...
function App() {
  ...
  const completeTask = (id) => {
    setTodoList(
      todoList.map((task) => {
        if (task.id === id) {   setNewcompleted(!newcompleted)
...
"
      ...
      <img className="list-img" src={list} alt="list" />
            <div className="empty-text">
              <div className="empty-t-1">You don't have tasks registered yet </div> <div className="empty-t-2"> Create tasks and organize your to-do items </div>
              </div>
            </div> : <div className="">
        {todoList.map((task) => {
          return (
